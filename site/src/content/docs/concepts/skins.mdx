...
The <DocsLink slug="how-to/install-from-shadcn">Video.js Shadcn registry</DocsLink> supports React and HTML, Tailwind and vanilla CSS, complete Player blocks, skin-only blocks, media facades, and individual React UI components.
