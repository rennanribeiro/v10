...
Adds Google Cast support to the player's media. It renders nothing — place it inside the player as a sibling of the media element, and pair it with a <DocsLink slug="reference/cast-button">CastButton</DocsLink>. See <DocsLink slug="how-to/cast-to-airplay-and-chromecast">Cast to AirPlay and Chromecast</DocsLink> for the complete setup.

## Import

<MediaImports media="google-cast" react="GoogleCast" />
...
<DocsLinkCard slug="how-to/cast-to-airplay-and-chromecast" description="Add remote playback to a player">Cast to AirPlay and Chromecast</DocsLinkCard>
