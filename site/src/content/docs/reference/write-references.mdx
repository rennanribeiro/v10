...
| Default poster placeholder | `{{VJS10_DEMO_POSTER_PLACEHOLDER}}` |
...
- **Hooks & Utilities** — Framework-specific hooks and shared utilities. Add
  `frameworks: ['react']` to React-only entries.
