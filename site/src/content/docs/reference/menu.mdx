...
<FrameworkCase frameworks={["html"]}>
  ...
  <media-menu-transition-root>
    <media-menu id="settings-menu">
      ...
      <media-menu-item commandfor="submenu"></media-menu-item>
...
Base Menu stays independent of nested navigation, transitions, and player settings. Current setting labels and availability belong to the player or skin composition rather than the Menu API. In React, render them from the option hooks. See <DocsLink slug="reference/playback-rate-radio-group">PlaybackRateRadioGroup</DocsLink>, <DocsLink slug="reference/quality-radio-group">QualityRadioGroup</DocsLink>, <DocsLink slug="reference/audio-track-radio-group">AudioTrackRadioGroup</DocsLink>, and <DocsLink slug="reference/captions-radio-group">CaptionsRadioGroup</DocsLink>.
