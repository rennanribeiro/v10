...
Set `name` when controls need to respond to a particular popup. While it is open, every Controls part in the same player container reflects that name through `data-active-popup`.
