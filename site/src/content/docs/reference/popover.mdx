...
Set `name` when other UI needs to respond to a particular popup. While it is open, the owning player container reflects that name through `data-active-popup`.
