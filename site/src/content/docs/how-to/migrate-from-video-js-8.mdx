...
Both also include AirPlay and <DocsLink slug="concepts/cast">Cast</DocsLink> buttons, which v8 had no answer for. Remote playback is a feature you compose in rather than a plugin you install.
