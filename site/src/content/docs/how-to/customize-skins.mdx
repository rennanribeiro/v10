...
The hosted Video.js registry installs a complete skin and its dependencies into your project. The generated files are ordinary app code, so their markup, class names, and styles are yours to change. <DocsLink slug="how-to/install-from-shadcn">Configure the `@videojs` registry namespace</DocsLink> first.

<FrameworkCase frameworks={["html"]}>

### Tailwind

<ShadcnCommand action="add @videojs/html-video-skin" />

### Vanilla CSS

<ShadcnCommand action="add @videojs/html-video-skin-css" />
...
<ShadcnCommand action="add @videojs/react-video-skin" />

### Vanilla CSS

<ShadcnCommand action="add @videojs/react-video-skin-css" />

</FrameworkCase>

Insert `-minimal` before `-css` to install the Minimal variant, for example `@videojs/react-video-skin-minimal-css`. Audio and live presets follow the same naming pattern.

- <DocsLink slug="skins/default-video">Default video skin</DocsLink>
- <DocsLink slug="skins/minimal-video">Minimal video skin</DocsLink>
- <DocsLink slug="skins/default-audio">Default audio skin</DocsLink>
- <DocsLink slug="skins/minimal-audio">Minimal audio skin</DocsLink>
- <DocsLink slug="skins/default-live-video">Default live video skin</DocsLink>
- <DocsLink slug="skins/minimal-live-video">Minimal live video skin</DocsLink>
- <DocsLink slug="skins/default-live-audio">Default live audio skin</DocsLink>
- <DocsLink slug="skins/minimal-live-audio">Minimal live audio skin</DocsLink>
...
<DocsLinkCard slug="how-to/install-from-shadcn">Install editable Video.js source with Shadcn</DocsLinkCard>
