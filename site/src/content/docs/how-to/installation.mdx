...
import ShadcnInstall from '@/components/installation/ShadcnInstall.astro';
...
<DocsLinkCard slug="how-to/install-from-shadcn" description="Configure the registry, inspect items, and maintain source-owned files">Install editable Video.js source</DocsLinkCard>

## Choose what to do next

<DocsLinkCard slug="how-to/customize-skins" description="Customize a packaged skin or install its source for full control">Customize skins</DocsLinkCard>
