...
Superseded by [Poster placeholder](poster-placeholder.md), which moves this behavior onto its own component. The record below is retained for the rationale it carried.
