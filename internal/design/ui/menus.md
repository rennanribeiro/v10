...
- Keep player-setting labels separate. React presets render labels from option hooks; HTML video skins render them through private skin composition behavior.
