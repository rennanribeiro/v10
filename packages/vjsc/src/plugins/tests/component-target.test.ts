...
describe('componentTargetPlugin', () => {
  ...
  it('identifies a single JSX child that can receive generated host props', async () => {
    const source = await transform(`
      import * as $ from '@fixture/components';
      export const elementTrigger = <$.Menu.Trigger><$.PlayButton /></$.Menu.Trigger>;
      export const textTrigger = <$.Menu.Trigger>Open</$.Menu.Trigger>;
    `);
