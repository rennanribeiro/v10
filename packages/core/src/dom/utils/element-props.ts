 ...
 * Event props ending in `Capture` use capture phase - Boolean props: `true` sets empty attribute, `false` removes -
 * `undefined` removes the attribute - Other props are set as string attributes
 */
