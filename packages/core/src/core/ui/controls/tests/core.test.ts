...
describe('ControlsCore', () => {
  describe('getState', () => {
    it('returns visible: true when controlsVisible is true', () => {
      ...
      core.setMedia(media);
      expect(core.getState()).toEqual({ activePopup: null, visible: true, userActive: true });
    });
    ...
    it('returns visible: false when controlsVisible is false', () => {
      ...
      core.setMedia(media);
      expect(core.getState()).toEqual({ activePopup: null, visible: false, userActive: true });
    });
    ...
    it('returns userActive: false when userActive is false', () => {
      ...
      core.setMedia(media);
      expect(core.getState()).toEqual({ activePopup: null, visible: true, userActive: false });
    });
    ...
    it('includes the active popup name', () => {
      ...
      expect(core.getState().activePopup).toBe('volume');
    });
