...
export default {
  ...
  time: {
    ...
    durationSuffix: '{duration} నిడివి',
    remainingSuffix: '{duration} మిగిలి',
    showElapsed: 'గడిచిన సమయం చూపు, {duration}.',
    showDuration: 'వ్యవధి చూపు, {duration}.',
    showRemaining: 'మిగిలిన సమయం చూపు, {duration}.',
    ...
    unknown: 'వీడియో లోడ్ కాలేదు, సమయం తెలియదు.',
  },
  playback: {
