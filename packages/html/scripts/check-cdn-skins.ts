/** Verify that every materialized skin survives the public CDN build as a browser-ready entry. */
...
function readSource(file: string): string {
  ...
  if (!existsSync(path)) fail(`Expected materialized skin source is missing: ${file}`);
