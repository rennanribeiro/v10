...
export function PauseIcon(props: SVGProps<SVGSVGElement>) {
  return createElement('svg', {
    ...
    dangerouslySetInnerHTML: {
      __html: '<rect width="5" height="14" x="2" y="2" rx="1.75"/><rect width="5" height="14" x="11" y="2" rx="1.75"/>',
    },
  });
}
