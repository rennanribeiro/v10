...
- Base React and HTML Menu modules contain no player-setting cores or selectors. React presets render values from their existing option hooks; HTML video skins own their setting labels and availability as composition behavior.
